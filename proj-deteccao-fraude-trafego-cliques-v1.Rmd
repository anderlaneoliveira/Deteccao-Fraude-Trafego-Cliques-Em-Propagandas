---
title: "Projeto Data Science - Aplicação de Machine Learning para Detecção de Fraudes"
author: "Anderlane Oliveira"
date: "Agosto/2021"
output:
  pdf_document: default
---
# Projeto para Detecção de Fraudes no Tráfego de Cliques 
...
#### Os APP's do tipo 3, 12 e 2 correspondem a 43,3% dos acessos que não realizam o dowload indicado nos anúncios.
#### Os horários de acesso estão distribuidos ao longo do período observado.
...
target_perc
```
#### Observa-se uma desproporção entre as classes a serem apresentadas ao algoritmo (99,8% para a classe 0, e 0,2% para a classe 1), situação que comprometerá o resultado, possivelmente gerando "overffiting" no modelo preditivo.
...
```
#### No modelo "modelo_knn_v2" apresentou-se aprox. 50% de cada uma das classes da variável target, obtendo um alto índice de acertos.
...
```
#### Observa-se que em ambos os casos a Acurácia dos modelos são acima de 90%, porém obtemos com o segundo modelo a capacidade de generalização que será importante ao apresentarmos novos dados para realizarmos previsões. 
